...
from vllm.third_party.tml_fa4.mask import (
    Sm100FusedMask as FusedMask,
)
from vllm.third_party.tml_fa4.tile_scheduler import SM100_TMEM_CAPACITY_COLUMNS
from vllm.third_party.tml_fa4.flash_fwd_sm100 import _TUNING_CONFIG
from vllm.third_party.tml_fa4.utils import ex2_emulation_2
...
class BlackwellFusedMultiHeadAttentionForward:
    ...
    def __call__(
        ...
        assert mRowMax is None, "SM100 forward with head_dim=256 does not support logits max"
        assert mSFQ is None and mSFK is None and mSFV is None, (
            "SM100 forward with head_dim=256 does not support mxfp8 blockscaled"
        )
